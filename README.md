...
Приложенный файл TestClasses.java (я разбил его на классы Flight, Segment и FlightBuilder) содержит упрощённые модельные классы и фабрику для получения тестовых образцов. Весь код необходимо поместить в пакет com.gridnine.testing
